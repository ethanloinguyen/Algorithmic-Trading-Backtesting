...
export default function StockModal({ stock, onClose }: { stock: Stock; onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Time range tabs ── */}
        <div className="flex items-center gap-0.5 px-6 pt-4 pb-1">
          {UI_RANGES.map((r) => (
            <button
              key={r}
        ...
        {/* ── Chart ── */}
        <div className="px-6 pt-2 pb-2" style={{ cursor: "crosshair" }}>
          {loading ? (
            <div
