...
class TestDcorEngine:
    def test_dcor_independent_series(self):
        ...
        from Algorithm.src.dcor_engine import dcor
...
class TestPermutation:
    def test_block_shuffle_preserves_length(self):
        ...
        from Algorithm.src.permutation import block_shuffle
        rng = np.random.default_rng(42)
    ...
    def test_null_pair_high_pvalue(self):
        ...
        from Algorithm.src.permutation import adaptive_permutation_test
        from Algorithm.src.dcor_engine import dcor_at_lag
...
class TestStability:
    def test_half_life_known_decay(self):
        ...
        from Algorithm.src.stability import estimate_half_life
...
class TestOOSStrategy:
    def test_strategy_long_short_symmetric(self):
        ...
        from Algorithm.src.oos_model import compute_rolling_zscore
        rng = np.random.default_rng(42)
    ...
    def test_sharpe_positive_for_good_strategy(self):
        ...
        from Algorithm.src.oos_model import compute_sharpe
...
class TestBootstrap:
    def test_signal_strength_range(self):
        ...
        from Algorithm.src.bootstrap import compute_signal_strength
...
class TestSynthetic:
    def test_synthetic_generation(self):
        ...
        from Algorithm.src.synthetic import generate_synthetic_universe
